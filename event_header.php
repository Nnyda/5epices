		...
		<div class="wrap-menu-header gradient1 trans-0-4">
			<div class="container h-full">
				<div class="wrap_header trans-0-3">
					...
					<div class="logo">
						<a href="index.php">
							<img src="#" alt="LOGO-5EPICES" data-logofixed="#">
						</a>
					</div>
					...
					<div class="wrap_menu p-l-45 p-l-0-xl">
						<nav class="menu">
							<ul class="main_menu">
								...
								<li>
									<a href="reserve_table.php">Reservation</a>
								</li>
	...
	<aside class="sidebar trans-0-4">
		...
		<ul class="menu-sidebar p-t-95 p-b-70">
			<li class="t-center m-b-13">
				<a href="index.php" class="txt19">Acceuil</a>
			</li>
			...
			<li class="t-center">
				<!-- Button2 -->
				<a href="orders.php" class="btn3 flex-c-m size13 txt11 trans-0-4 m-l-r-auto">
					Commande
				</a>
			</li>
			<br>
			<li class="t-center">
				<!-- Button3 -->
				<a href="reserve_table.php" class="btn3 flex-c-m size13 txt11 trans-0-4 m-l-r-auto">
					Reservation
				</a>
			</li>
		</ul>
